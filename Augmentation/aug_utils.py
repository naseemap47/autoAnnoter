...
import cv2
import numpy as np
from tools.tool_utils import get_xml, write_xml, get_txt, write_txt
...
# ---------------------------------------- YOLO (TXT) ----------------------------------------
def generate_anotT_RandomHSV(image_list:list, path_to_labels:str, path_to_save:str, name_id:str, hue=None, saturation=None, brightness=None):
    for img_path in image_list:
        img_name = os.path.split(img_path)[1]
        img = cv2.imread(img_path)
        
        # Read TXT
        txt_path = f"{path_to_labels}/{os.path.splitext(img_name)[0]}.txt"
        ...
        if len(bbox_list) > 0:
            ...
            if len(bbox_aug) > 0:
                ...
                cv2.imwrite(f"{path_to_save}/{os.path.splitext(img_name)[0]}_{name_id}.jpg", img_aug)
                # Save TXT
                txt_name = f"{os.path.splitext(img_name)[0]}_{name_id}.txt"
                path_to_txt_save = f"{path_to_save}/{txt_name}"
                h, w, _ = img_aug.shape
                write_txt(path_to_txt_save, bbox_aug, class_list, h, w)


def generate_anotT_Rotate(image_list:list, path_to_labels:str, path_to_save:str, name_id:str, angle:int):
    for img_path in image_list:
        img_name = os.path.split(img_path)[1]
        img = cv2.imread(img_path)
...
def generate_anotT_RandomRotate(image_list:list, path_to_labels:str, path_to_save:str, name_id:str, angle:int):
    for img_path in image_list:
        img_name = os.path.split(img_path)[1]
        img = cv2.imread(img_path)
...
def generate_anotT_Translate(image_list:list, path_to_labels:str, path_to_save:str, name_id:str, translate_x:float, translate_y:float):
    for img_path in image_list:
        img_name = os.path.split(img_path)[1]
        img = cv2.imread(img_path)
...
def generate_anotT_RandomTranslate(image_list:list, path_to_labels:str, path_to_save:str, name_id:str, translate:float):
    for img_path in image_list:
        img_name = os.path.split(img_path)[1]
        img = cv2.imread(img_path)
...
def generate_anotT_Scale(image_list:list, path_to_labels:str, path_to_save:str, name_id:str, scale_x:float, scale_y:float):
    for img_path in image_list:
        img_name = os.path.split(img_path)[1]
        img = cv2.imread(img_path)
...
def generate_anotT_RandomScale(image_list:list, path_to_labels:str, path_to_save:str, name_id:str, scale:float):
    for img_path in image_list:
        img_name = os.path.split(img_path)[1]
        img = cv2.imread(img_path)
...
def generate_anotT_Shear(image_list:list, path_to_labels:str, path_to_save:str, name_id:str, shear:float):
    for img_path in image_list:
        img_name = os.path.split(img_path)[1]
        img = cv2.imread(img_path)
...
def generate_anotT_RandomShear(image_list:list, path_to_labels:str, path_to_save:str, name_id:str, shear:float):
    for img_path in image_list:
        img_name = os.path.split(img_path)[1]
        img = cv2.imread(img_path)
...
def generate_anotT_flipud(image_list:list, path_to_labels:str, path_to_save:str, name_id:str):
    for img_path in image_list:
        img_name = os.path.split(img_path)[1]
        img = cv2.imread(img_path)
...
def generate_anotT_fliplr(image_list:list, path_to_labels:str, path_to_save:str, name_id:str):
    for img_path in image_list:
        img_name = os.path.split(img_path)[1]
        img = cv2.imread(img_path)
